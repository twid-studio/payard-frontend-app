  ...
  return (
    <footer className={s.footer}>
      <div className={"grid " + s.top}>
        <Link href="/" target="_blank" className={"bold " + s.adress}>
          <p>Office Adress</p>
          <p>
        ...
        <div className={s.list}>
          ...
          {linksList.anchor.map((curr, i) => (
            <Link href={curr.link} key={i} className="small-text">
              {curr.text}
            </Link>
          ))}
        </div>
      ...
      <div className={"grid " + s.bottom}>
        ...
        <Link href="https://twid.marketing/" target="_blank" className={"shadow small-text second-mobile second-tablet " + s.link}>
          Made by twid
        </Link>
      </div>
    </footer>
